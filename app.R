...
fluidRow(
  div(class = "right-image",
    ...
    fluidRow(
            column(
              ...
              div(class = "right-title",
                  titlePanel("a seed germination database for characteristic species of Mediterranean habitats", windowTitle = "a seed germination database for characteristic species of Mediterranean habitats"),
             # )
            ))),
    ...
    selectizeInput("spp", label = "Species", choices = spp, selected = spp[1]),
     ...
     fluidRow(
       column(width = 12,
              plotOutput("plot_map", width = "800px", height = "400px"))),  # Actual figure output 
